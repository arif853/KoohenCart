<div class="modal fade" id="signup" aria-hidden="true" aria-labelledby="signupModalToggleLabel" tabindex="-1">
        ...
        <main class="main">
            <div class="row">
                <div class="col-lg-12 m-auto">
                    <div class="widget-taber-content p-30 ">
                        <div class="padding_eight_all bg-white">
                            <div class="heading_s1">
                                <h3 class="mb-10">Create an Account</h3>
                            </div>
                            ...
                            <div class="d-grid gap-3 mb-4 ">
                                <a href="{{url('/auth/google/redirect')}}" class="btn w-50 btn-light font-sm m-auto">
                                ...
                                <a href="{{url('/auth/facebook/redirect')}}" class="btn w-50 btn-light font-sm m-auto">
                                    <svg aria-hidden="true" class="icon-svg" width="20" height="20" viewBox="0 0 20 20">
                            ...
                            <div class="text-muted text-center">Already have an account?
                                <a href="#" data-bs-target="#login" data-bs-toggle="modal" data-bs-dismiss="modal">Sign in now</a></div>
