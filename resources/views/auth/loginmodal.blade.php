                    ...
                    <div class=" mx-auto my-auto card-login">
                        ...
                        <div class=" p-40">
                            ...
                            <form method="POST" action="{{ route('customer.login') }}">
                                ...
                                <div class="mb-3">
                                    <label for="login_identifier" class="mb-1">Email or Phone Number</label>
                                    <input class="form-control" placeholder="Email or Phone Number" id="login_identifier" type="text" name="login_identifier" :value="old('login_identifier')" required autofocus autocomplete="login_identifier">
                           ...
                           <div class="d-grid gap-3 mb-4">
                               <a href="{{url('/google/redirect')}}" class="btn w-100 btn-light font-sm">
                            ...
                            <p class="text-center mb-4">Don't have account?
                                <a href="#" data-bs-target="#signup" data-bs-toggle="modal" data-bs-dismiss="modal">Sign up</a></p>
                        </div>
                    </div>
                </section>
            </main>
