                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.php"><img alt="Evara" src="{{asset('')}}frontend/assets/imgs/shop/thumbnail-3.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="product-details.php">Daisy Casual Bag</a></h4>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.php"><img alt="Evara" src="{{asset('')}}frontend/assets/imgs/shop/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                                    <h4><a href="product-details.php">Corduroy Shirts</a></h4>
