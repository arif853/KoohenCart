                    ...
                    <div class="col-lg-12">
                        <div class="single-page pr-30">
                            ...
                            <div class="single-content">
                                <h4>Welcome to Koohen’s Privacy Policy</h4>
                                <p>This Privacy Policy describes how koohen.com (the “Site” or “we”) collects, uses, and discloses your Personal
                                    Information when you visit or make a purchase from the Site.
                                    Collecting Personal Information When you visit the Site, we collect certain information about your device,
                                    your interaction with the Site, and information necessary to process your purchases. We may also collect additional information if you contact us for customer support. In this Privacy Policy, we refer to any information that can uniquely identify an individual (including the information below) as “Personal Information”. See the list below for more information about what Personal Information we collect and why.
                                </p>
                                ...
                                <ol start="1">
                                    <li>
                                        ...
                                        (including credit card numbers, Mobile Banking numbers), email address, and phone number.
                                        </p>
                                    </li>
                                    <li>
                                        <p>
                                            Purpose of collection: to provide products or services to you to fulfill our contract, to process your payment information, arrange for shipping, and provide you with invoices and/or order confirmations, communicate with you, screen our orders for potential risk or fraud, and
                                ...
                                <p>
                                    We are committed to ensure the security of your information. We maintain suitable physical, electronic and managerial procedures to safeguard and secure your information by preventing unauthorized access. Read here how we use cookies, other websites and contents.
                                    ...
                                    A cookie in no way gives us access to your computer or any information about you, other than the data you choose to share with us.</p>
                                </p>
                                ...
                                <h4>Data Deletion Policy</h4>
                                    <p>A user of koohen.com product or service can request account data Deletion anytime by sending an email to (support@koohen.com).
                                        With the request of user data or account relation all previous orders, reviews, product questions or related data will be removed from your account dashboard but product reviews will remain on the website. Please be noted that once the data is deleted it can't be retrieved or can't be undone.
                                        So, we request you to think twice to send the data relation request. Once the data relation request is sent by email it will be done within the next 72 hours.</p>
