    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('order.place_order.curier') }}" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-12 mb-2">
                                <label for="invoice" class="form-label">Invoice Number<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="invoice" name="invoice"
                                    value="{{ $order->invoice_no }}">
                            </div>
                            <input type="hidden" name="id" value="{{ $order->id }}" />
                            <input type="hidden" name="consignment_id" value="{{ $order->consignment_id }}" />
                            ...
                            <div class="col-md-12 mb-2">
                                <label for="recipient_address" class="form-label">Recipient Address<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12 mb-2">
                                <label for="recipient_phone" class="form-label">Recipient Phone Number<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12 mb-2">
                                <label for="cod_amount" class="form-label">CoD Amount<span
                                        class="text-danger">*</span></label>
